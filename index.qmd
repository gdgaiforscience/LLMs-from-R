...
> Note: I needed to also add additional packages to my setup inclusing: `install.packages(c("coro","withr","curl","vctrs","reticulate","duckdb","blob","commonmark","dplyr","promises"), lib="./Rlibs")` - you may have to install a few on your local machine.
...
Consider [ollamar](https://hauselin.github.io/ollama-r/) for local LLMs.
