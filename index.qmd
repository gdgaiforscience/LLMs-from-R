...
> Be aware of the [Free Tier Rate/Usage limits]. Use the `gemini-2.5-flash-lite`, `gemini-3.1-flash-lite-preview`, `gemini-2.5-flash`, and `gemini-3-flash-preview`. Use [`chat_google_vertex`](https://ellmer.tidyverse.org/reference/chat_google_gemini.html) endpoints to take advantage of cloud credits.
